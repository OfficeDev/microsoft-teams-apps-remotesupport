            ...
            try
            {
                var strings = new
                {
                    ...
                    buildForm = new
                    {
                        ...
                        staticInput1 = this.localizer.GetString("staticInput1").Value,
                        staticInput2 = this.localizer.GetString("staticInput2").Value,
                        staticText2 = this.localizer.GetString("staticText2").Value,
